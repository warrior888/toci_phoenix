...
insert into lookup (id_lookup_type, name) values (1, 'Michał');
insert into lookup (id_lookup_type, name) values (1, 'Karol');
insert into lookup (id_lookup_type, name) values (1, 'Rafał');
insert into lookup (id_lookup_type, name) values (1, 'Tadeusz');
insert into lookup (id_lookup_type, name) values (1, 'Jarosław');
insert into lookup (id_lookup_type, name) values (1, 'Janusz');
insert into lookup (id_lookup_type, name) values (1, 'Konrad');
insert into lookup (id_lookup_type, name) values (1, 'Paweł');
...
insert into personal_data (id_name,surname,pesel,birth_date,registration_date,address) values (1, 'Kowalski', 84080818074, '1984-08-08','2015-12-10','Pomarańczowa 3');
...
insert into personal_data (id_name,surname,pesel,birth_date,registration_date,address) values (4,'Marian',00010244256,'2000-01-01','2016-06-02','Długa 15');
...
insert into personal_data (id_name,surname,pesel,birth_date,registration_date,address) values (8,'Bułka',00010244256,'2000-01-01','2016-06-02','Konkretna 32');
...
insert into personal_data (id_name,surname,pesel,birth_date,registration_date,address) values (15,'Putin',00010244256,'1952-10-07','2016-06-02','Łagrowa 66/6');
