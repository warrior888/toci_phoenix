...
namespace Toci.Utilities.Test.Developers.Warrior
{
    ...
    public class ModelGeneratorTest
    {
        ...
        public void Generate()
        {
            ...
            wrapperModel.DestinationPath = @"C:\self\toci\software\sourcetree\phoenix\TociAbstractBaseGenerator\Toci.RoyalSchool.Dal\test";
            ...
            wrapper.GenerateModel(wrapperModel, "data/ddlExample.txt");
        }
    }
}