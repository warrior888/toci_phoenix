...
$askerMessage= "Przesłał: ".$askerName.", email: ".$_POST['contact-input-email']." mail: ".$_POST['contact-input-message']." <br/ ><br />".$_POST['contact-input-message'];



$mail=new MailSender();
$result = $mail->SendMail($askerSubject,$askerMessage,"programowanie.szkolenia.toci@gmail.com",$askerName);
