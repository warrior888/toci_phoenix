...
namespace Toci.Provider
{
    ...
    /// </summary>
    public class TociApplyRedirectContext : BaseContext<TociAuthenticationOptions>
    {
        /// <summary>
        ...
        public TociApplyRedirectContext(IOwinContext context, TociAuthenticationOptions options,
